...
struct dependency_analyzer
{
    ...
    void build_stmt_instrument_dependency(bool strict_instrument_order);
    ...
    float get_dependency_score(set<pair<int, int>>& blocking_tid_pairs);
    int check_original_stmt_pos(int instrument_idx);
};
